...
var _tshm$elm_doctest$DocTest$createTempModule = F2(
	function (src, specs) {
		...
		var isport = function (match) {
			return _elm_lang$core$Native_Utils.eq(
				_elm_lang$core$List$head(match.submatches),
				_elm_lang$core$Maybe$Just(_elm_lang$core$Maybe$Nothing));
		};
		var newheader = 'module DoctestTempModule__ exposing (doctestResults_)';
		var moduledecr = function (match) {
			var _p5 = match.submatches;
			if ((_p5.ctor === '::') && (_p5._0.ctor === 'Just')) {
				return A2(_elm_lang$core$Basics_ops['++'], _p5._0._0, newheader);
			} else {
				return newheader;
			}
		};
		var re = _elm_lang$core$Regex$regex('^(\\w*\\s*)module\\s+(\\w)+\\s+?exposing\\s+\\([^)]+\\)');
		var newmodule = A4(
...
var _tshm$elm_doctest$DocTest$collectSpecs = function (txt) {
	...
	var extract = function (m) {
		...
		if ((((_p6.ctor === '::') && (_p6._0.ctor === 'Just')) && (_p6._1.ctor === '::')) && (_p6._1._0.ctor === 'Just')) {
			return A3(
...
var _tshm$elm_doctest$DocTest$createReport = F2(
	function (filename, specs) {
		var reportFailure = function (_p7) {
			var _p8 = _p7;
			return A2(
				_elm_lang$core$String$join,
				'\n',
					...
					[
						...
						A2(
							...
							A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString(_p8.line),
									A2(_elm_lang$core$Basics_ops['++'], ': expression ', _p8.test))))),
						A2(_elm_lang$core$Basics_ops['++'], 'expected: ', _p8.expected),
						A2(_elm_lang$core$Basics_ops['++'], ' but got: ', _p8.output),
						''
					]));
		};
		var failures = A2(
...
var _tshm$elm_doctest$Main$main = {
	main: _elm_lang$virtual_dom$VirtualDom$programWithFlags(
		{
			init: function (_p6) {
				return {
					ctor: '_Tuple2',
